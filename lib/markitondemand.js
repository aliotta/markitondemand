 ...
 * @return {Boolean}       true if symbol is a string and valid format
 */
 ...
 * @return {object}     Returns the payload of the API request
 */
 ...
 * @param  {string} symbol the stock symbol that you want to lookup
 * @return {object}        stock quote data
 */
 ...
 * @return {array}          array of objects with stock quote data
 */
 ...
 * @param  {array} symbols array of symbols
 * @return {object}        object with stock quote objects keyed by the symbols
 */
